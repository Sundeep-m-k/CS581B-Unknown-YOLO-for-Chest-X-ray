...
def get_args_parser():
    parser = argparse.ArgumentParser('Set transformer detector (Hypothesis 1: ResNet101 backbone)', add_help=False)
    ...
    # * Backbone
    # Hypothesis 1: use a stronger ResNet backbone by default
    parser.add_argument('--backbone', default='resnet101', type=str,
                        help="Name of the convolutional backbone to use (e.g., resnet50, resnet101)")
...
def main(args):
    ...
    print("Start training (Hypothesis 1: ResNet101 backbone)")
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser('DETR training and evaluation script (Hypothesis 1: ResNet101 backbone)',
