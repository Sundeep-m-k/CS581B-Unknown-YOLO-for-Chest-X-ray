...
model = dict(
    ...
    test_cfg=dict(
        ...
        max_per_img=100))
work_dir = '/data/sundeep/Point-Beyond-Class/Output/outfiles/models/mmdet-RSNA/exp2_fcos512noBB_50p__train_LableBox_PseudoBox__exp4_stage1_data50p_1pts_Erase20_jit005_unlabelLossL2Loss50_Load2ptsconsPth200'
gpu_ids = range(0, 1)
